-- Prevent duplicate project aggregate increments when Stripe project payments are retried.

ALTER TABLE public.project_contributions
ADD COLUMN IF NOT EXISTS stripe_session_id text,
ADD COLUMN IF NOT EXISTS stripe_payment_intent_id text;

CREATE UNIQUE INDEX IF NOT EXISTS idx_project_contributions_session_once
ON public.project_contributions (stripe_session_id)
WHERE stripe_session_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS idx_project_contributions_intent_once
ON public.project_contributions (stripe_payment_intent_id)
